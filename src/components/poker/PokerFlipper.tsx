...
export const PokerFlipper = (props: {cardValue: number, verticalCenterSize?: number, horizontalCenterSize?: number, onRotate?: () => void}) => {
    ...
    return (
        <div className="poker_flipper" ref={containerRef}>
            ...
            { !isNaN(angle) && <div className={["poker_frontface", (startingSides.top || startingSides.bottom) ? "flip" : undefined].join(" ")} style={Object.assign({}, offset, {transformOrigin: anchor}, {"--angle": angle, "--clip": frontfaceClip})}><Poker cardValue={props.cardValue}/></div> }
